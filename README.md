# 🚗 안녕하세요, 임베디드 엔지니어러 성장 중인 안해성입니다.

하드웨어와 소프트웨어의 상호작용에 대한 흥미를 바탕으로 특히 자동차 전장과 SoC (System on Chip) 분야에 관심 있습니다.
...
* **임베디드 SW 최적화**: C/C++ 기반 펌웨어 개발, ROS 2 기반 자율주행 로봇 개발
...
* **교류모터 이론 및 임베디드기반 인버터 시뮬레이션 실습** | 충북대학교 미래자동차 혁신융합대학사업단 (25.08.04-25.08.05)
    * DC/AC 모터 원리, PWN 제어 이해 / Matlab - PSIM 이용한 VVVF 인버터 개발 실습
