...
### [📡 MFRC522 RFID 리눅스 커널 드라이버 개발](https://github.com/HaesungAhn0205/mfrc522-linux-kernel-driver.git)
* **설명**: 라즈베리파이 환경에서 RFID 모듈을 사용하기 위한 디바이스 드라이버 개발
* **핵심 역량**: C Programming, Linux BSP, SPI
* **Tech Stack**: C
---
